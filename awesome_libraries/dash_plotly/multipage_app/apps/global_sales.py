...
# Original data: https://www.kaggle.com/shivkp/customer-behaviour
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Pre(
                            children="Payment type", style={"fontSize": "150%"}
                        ),
                        dcc.Dropdown(
                            id="pymnt-dropdown",
                            value="DEBIT",
                ...
                html.Div(
                    [
                        html.Pre(
                            children="Country of destination",
                            style={"fontSize": "150%"},
                        ),
                        dcc.Dropdown(
                            id="country-dropdown",
...
def display_value(pymnt_chosen, country_chosen):
    ...
    """Creates figure based on applied filters

    Args:
    pymnt_chosen (_type_): _description_
    country_chosen (_type_): _description_

    Returns:
        plotly_fig: a chart of plotly fig type
    """

    dfg_fltrd = dfg[
        (dfg["Order Country"] == country_chosen)
