...
class KafkaConsumer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            ),  # using join in case of more kafka brokers
    ...
    def on_assign(self, consumer, partitions):
        ...
        for partition in partitions:
            if self.offset_earliest:
                ...
                logger.info("f{self.topic_name_pattern} set offset to earliest")
        ...
        try:
            ...
            if msg:
                if not msg.error():
                    ...
                    logger.info(f"message consumed: {msg.key()} and {msg.value()}")
                    return 1
